...
__all__ = [
    'DISPID_SRCEEndStream', 'DISPID_SPIStartTime',
    'SPRS_ACTIVE_USER_DELIMITED', 'eLEXTYPE_PRIVATE17',
    '__MIDL_IWinTypes_0009', 'eLEXTYPE_RESERVED6', 'DISPID_SAVolume',
    'SRSEDone', 'SpeechVoiceEvents', 'SPWORDLIST', 'DISPID_SPPsItem',
    'DISPID_SVSpeakStream', 'SRATopLevel', 'SpLexicon',
    'SRCS_Disabled', 'SPGS_EXCLUSIVE', 'DISPID_SRCBookmark',
    'SAFTCCITT_uLaw_11kHzStereo', 'ISpSerializeState',
    'DISPID_SPEPronunciation', 'SPWF_INPUT', 'SpeechAudioProperties',
    'SpeechWordPronounceable', 'eLEXTYPE_RESERVED7',
    'DISPID_SGRSTsItem', 'DISPID_SpeechAudioStatus',
    'DISPIDSPTSI_SelectionLength', 'SECLowConfidence',
    'DISPID_SPIGetDisplayAttributes', 'SpeechStreamFileMode',
    'ISpeechPhraseElements', 'SP_VISEME_21', 'SPSHT_NotOverriden',
    'DISPID_SGRSTransitions', 'DISPID_SBSRead',
    'SpeechStreamSeekPositionType', 'DISPID_SRGSetWordSequenceData',
    'eWORDTYPE_DELETED', 'ISpResourceManager', 'SINone',
    'SPSHT_OTHER', 'SPEI_PHRASE_START', 'SpWaveFormatEx',
    'DISPID_SRCERequestUI', 'ISpObjectToken', 'SVEAudioLevel',
    'DISPID_SVAudioOutputStream', 'UINT_PTR',
    'DISPID_SVSyncronousSpeakTimeout', 'eLEXTYPE_PRIVATE10',
    'SPSNoun', 'DISPID_SAFSetWaveFormatEx', 'SPRULESTATE',
    'DISPID_SVEPhoneme', 'ISpeechRecoResultDispatch',
    'DISPID_SPERetainedStreamOffset', 'Speech_Max_Pron_Length',
    'DISPID_SPCIdToPhone', 'DISPID_SRGSetTextSelection',
    'DISPID_SPRules_NewEnum', 'SVP_12', 'DISPID_SPRuleFirstElement',
    'DISPID_SPPs_NewEnum', 'SpeechAudioVolume', 'SPSEMANTICERRORINFO',
    'SSFMOpenReadWrite', 'DISPID_SPRuleConfidence', 'ISpProperties',
    'SPSMF_UPS', 'ISpNotifyTranslator', 'DISPID_SRCEventInterests',
    'DISPID_SLRemovePronunciation', 'DISPID_SPRuleNumberOfElements',
    'SRERequestUI', 'DISPID_SMSAMMHandle', 'DISPID_SRCState',
    'SpFileStream', 'Speech_Default_Weight',
    'DISPID_SWFESamplesPerSec', 'DISPID_SBSFormat',
    'SPPS_NotOverriden', 'SPEI_MIN_SR', 'ISpeechDataKey',
    'SSSPTRelativeToCurrentPosition', 'DISPID_SpeechObjectToken',
    'SAFT8kHz8BitMono', 'SPPS_SuppressWord',
    'DISPID_SPEEngineConfidence', 'SRAImport',
    'DISPID_SOTGetAttribute', 'ISpeechMMSysAudio',
    'DISPID_SLAddPronunciationByPhoneIds', 'DISPID_SLPPhoneIds',
    'DISPID_SRCResume', 'SPWAVEFORMATTYPE', 'SPVPRI_OVER',
    'DISPID_SREmulateRecognition', 'SSTTWildcard',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'DISPID_SPPBRestorePhraseFromMemory', 'DISPID_SDKEnumValues',
    'SPEI_SR_RETAINEDAUDIO', 'STCInprocHandler', 'SPEI_VOICE_CHANGE',
    'SpMemoryStream', 'ISpeechObjectTokenCategory', 'SPPARTOFSPEECH',
    'SVSFlagsAsync', 'DISPID_SLPPartOfSpeech', 'SASPause',
    'SGRSTTEpsilon', 'DISPID_SRRTimes', 'SAFTCCITT_ALaw_11kHzMono',
    'SAFT12kHz16BitStereo', 'ISpRecognizer2',
    'DISPID_SRCSetAdaptationData', 'SPCT_SUB_DICTATION',
    'SDKLLocalMachine', 'DISPID_SPEAudioStreamOffset',
    'SpeechAudioFormatType', 'SVSFParseSapi', 'ISpRecognizer',
    'SVP_5', 'SPBOOKMARKOPTIONS', 'IStream', 'SPFM_CREATE_ALWAYS',
    'SPRECOSTATE', 'DISPID_SCSBaseStream', 'SPAUDIOSTATE',
    ...
    'ISpRecoContext', 'SpeechAddRemoveWord', 'DISPID_SMSADeviceId',
    'SVSFVoiceMask', 'SPCONTEXTSTATE', 'DISPID_SLPsCount', 'SLTUser',
    'DISPID_SGRsCommit', 'SVP_20', 'DISPID_SRIsShared',
    ...
    'SPRST_INACTIVE_WITH_PURGE', 'DISPID_SRCEHypothesis', 'ISpStream',
    'SpeechCategoryVoices', 'SPEI_ACTIVE_CATEGORY_CHANGED',
    'DISPID_SpeechMMSysAudio', 'DISPID_SRCEAudioLevel',
    'SpeechGrammarTagDictation', 'SFTSREngine', 'SPEI_SR_PRIVATE',
    'SpNotifyTranslator', 'DISPID_SVESentenceBoundary', 'LONG_PTR',
    'SPEI_END_INPUT_STREAM', 'SVP_16', 'SPEI_SENTENCE_BOUNDARY',
    'STCInprocServer', 'SPEI_PROPERTY_NUM_CHANGE',
    'DISPID_SDKGetlongValue', 'ISpeechRecognizerStatus',
    'SPEI_START_INPUT_STREAM', 'SPEI_SOUND_END', 'ISpeechRecognizer',
    'SPEI_INTERFERENCE', 'ISpeechPhraseReplacements',
    'DISPID_SpeechWaveFormatEx', 'SRESoundEnd', 'SREBookmark',
    'DISPID_SLWs_NewEnum', 'SVEAllEvents',
    'DISPID_SpeechPhraseBuilder', 'SRAONone', 'SVEEndInputStream',
    ...
    'SPEI_TTS_PRIVATE', 'SPAO_RETAIN_AUDIO', 'DISPID_SRGCommit',
    'WAVEFORMATEX', 'ISpeechPhraseRule', 'DISPID_SPRulesItem',
    'DISPID_SPPEngineConfidence', 'SpeechEmulationCompareFlags',
    'DISPID_SAEventHandle', 'DISPID_SASNonBlockingIO', 'SVP_11',
    'SAFT11kHz16BitStereo', 'SPEI_HYPOTHESIS', 'SPSERIALIZEDPHRASE',
    'SDTProperty', 'DISPID_SpeechPhraseProperty',
    'SpObjectTokenCategory', 'SPEI_FALSE_RECOGNITION', 'SDTAll',
    'SRSEIsSpeaking', 'SpeechBookmarkOptions', 'SPPROPERTYINFO',
    'SpCompressedLexicon', 'DISPID_SRState', 'SVF_Stressed',
    'ISpShortcut', 'SAFTCCITT_ALaw_22kHzMono',
    'DISPID_SVEEnginePrivate',
    'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN', 'SWTDeleted',
    'SpeechRecognizerState', 'SPCT_SLEEP', 'ISpStreamFormatConverter',
    'eLEXTYPE_PRIVATE7', 'DISPID_SPRNumberOfElements',
    'DISPID_SLGenerationId', 'SPFM_NUM_MODES',
    'DISPIDSPTSI_ActiveLength', 'SPPS_Interjection',
    'SPEI_SR_AUDIO_LEVEL', 'DISPID_SpeechDataKey', 'SpeechLoadOption',
    'ISpeechPhraseInfo', 'SRAInterpreter', 'Speech_Max_Word_Length',
    'SAFT11kHz8BitMono', 'SAFT12kHz16BitMono', 'DISPID_SRRSpeakAudio',
    'SPEVENT', 'SVP_0', 'eLEXTYPE_LETTERTOSOUND', 'ISpRecoGrammar2',
    'SREHypothesis', 'SSTTDictation', 'SPWT_PRONUNCIATION',
    'SRAORetainAudio', 'SpeechGrammarState', 'SINoise',
    'DISPID_SRGetRecognizers', 'SBONone', 'ISpNotifySource',
    'SPSVerb', 'SAFT16kHz8BitMono', 'SWPUnknownWordUnpronounceable',
    'DISPID_SOTSetId', 'DISPID_SLRemovePronunciationByPhoneIds',
    'SVPAlert', 'SRERecoOtherContext', 'DISPID_SWFEChannels',
    'DISPID_SpeechPhoneConverter', 'SPSEMANTICFORMAT',
    'SVEVoiceChange', 'SPAR_Medium', 'SPAS_RUN', 'SPWORDTYPE',
    'eLEXTYPE_RESERVED8', 'SRTAutopause', 'DISPID_SVSInputWordLength',
    'tagSPTEXTSELECTIONINFO', 'eWORDTYPE_ADDED', 'SRADefaultToActive',
    'eLEXTYPE_APP', 'SPAS_CLOSED', 'ISpPhoneticAlphabetConverter',
    'ISpRecoCategory', 'DISPID_SVAlertBoundary', 'SAFT12kHz8BitMono',
    'SP_VISEME_17', 'SPINTERFERENCE', 'DISPID_SASetState',
    'SPFILEMODE', 'DISPID_SPIProperties', 'DISPID_SLWType',
    'SPEI_START_SR_STREAM', 'DISPID_SVGetAudioOutputs',
    'DISPID_SPIRule', 'DISPID_SRStatus', 'ISpeechRecoContext',
    'DISPID_SLPSymbolic', 'DISPID_SRCPause', 'SWTAdded',
    'SAFTADPCM_11kHzStereo', 'ISpRecognizer3',
    'SpeechCategoryAppLexicons', 'SAFT32kHz16BitMono', 'SPLO_DYNAMIC',
    'SPAR_Unknown', 'DISPID_SpeechPhraseRules', 'SSSPTRelativeToEnd',
    'SAFT16kHz8BitStereo', 'DISPID_SVPause',
    'DISPID_SDKGetBinaryValue', 'SPSModifier', 'SAFTADPCM_44kHzMono',
    'SP_VISEME_14', 'SPFM_CREATE', 'SpeechAudioFormatGUIDText',
    'SITooFast', 'SAFTADPCM_44kHzStereo', 'eLEXTYPE_PRIVATE12',
    'DISPID_SLGetPronunciations', 'DISPID_SpeechVoiceStatus',
    'SAFTADPCM_8kHzMono', 'DISPID_SDKSetLongValue', 'SGRSTTDictation',
    'SPPHRASERULE', 'ISpPhrase', 'SpeechAudioFormatGUIDWave',
    'SAFTText', 'SpeechCategoryAudioOut', 'SRSInactiveWithPurge',
    'DISPID_SVDisplayUI', 'DISPID_SPRuleName',
    'SAFTCCITT_uLaw_22kHzMono', 'SVP_7', 'SVEBookmark',
    'DISPID_SPPParent', 'DISPID_SABIBufferSize',
    'DISPID_SRCESoundEnd', 'SPAR_High', 'SpeechPropertyResourceUsage',
    'SECFDefault', 'SPINTERFERENCE_TOOFAST', 'SRESoundStart',
    'DISPID_SVSCurrentStreamNumber', 'SPSInterjection',
    'SPWF_SRENGINE', 'DISPID_SRRSaveToMemory', 'DISPID_SRProfile',
    '__MIDL___MIDL_itf_sapi_0000_0020_0001', 'SpeechTokenContext',
    'SP_VISEME_10', 'SP_VISEME_11', 'SDKLCurrentConfig',
    'DISPID_SPRuleChildren', '_RemotableHandle',
    'DISPID_SRSSupportedLanguages', 'DISPID_SpeechPhraseElements',
    'SPXMLRESULTOPTIONS', 'SPRS_ACTIVE', 'DISPID_SVWaitUntilDone',
    'SP_VISEME_1', 'DISPID_SGRSTWeight',
    'SpeechVoiceSkipTypeSentence', 'SVEStartInputStream',
    'DISPID_SPPConfidence', 'SVEWordBoundary', 'SAFT8kHz16BitMono',
    'eLEXTYPE_RESERVED9', 'SAFTCCITT_ALaw_8kHzStereo',
    'SPGS_DISABLED', 'SLODynamic', 'SAFT24kHz8BitMono',
    'DISPID_SGRInitialState', 'DISPID_SpeechPhraseReplacement',
    'SDKLDefaultLocation', 'DISPID_SPERequiredConfidence',
    'ISpeechResourceLoader', 'ISpXMLRecoResult', 'SPEVENTSOURCEINFO',
    'DISPID_SVStatus', 'DISPID_SpeechPhraseAlternate',
    'SpeechWordType', 'SAFTCCITT_uLaw_8kHzStereo', 'SPPHRASEELEMENT',
    'SGDSInactive', '_ISpeechRecoContextEvents',
    'DISPID_SRRRecoContext', 'SGRSTTTextBuffer',
    'DISPID_SRGCmdLoadFromResource',
    'DISPID_SRCEPropertyNumberChange', 'SRCS_Enabled',
    'SDKLCurrentUser', 'DISPID_SOTCEnumerateTokens',
    'SpeechRuleState', 'SpeechFormatType', 'eLEXTYPE_PRIVATE3',
    'SFTInput', 'DISPID_SVEBookmark', 'SPFM_OPEN_READWRITE',
    'ISpStreamFormat', 'DISPID_SPRsItem',
    'DISPID_SpeechGrammarRuleStateTransitions', 'SPAUDIOSTATUS',
    'DISPID_SRGCmdSetRuleState', 'DISPID_SRRTTickCount',
    'SAFT24kHz16BitMono', 'DISPID_SOTDisplayUI',
    'DISPID_SPIEnginePrivateData', 'DISPID_SLWLangId',
    'SpeechRegistryLocalMachineRoot', 'SAFTTrueSpeech_8kHz1BitMono',
    'SpeechVoicePriority', 'SVSFUnusedFlags', 'DISPID_SWFEExtraData',
    'SpShortcut', 'SPCT_DICTATION', 'SP_VISEME_9',
    ...
    'SVESentenceBoundary', 'eLEXTYPE_PRIVATE4', 'DISPID_SVRate',
    'DISPID_SPRDisplayAttributes', 'ISpPhoneConverter',
    'DISPID_SVVolume', 'DISPID_SPRuleParent', 'SPPS_RESERVED3',
    'SpeechPropertyLowConfidenceThreshold', 'SAFT16kHz16BitMono',
    'DISPID_SRGetPropertyNumber', 'ISpeechRecoResult',
    'DISPID_SABIEventBias', 'SAFT8kHz8BitStereo',
    'SAFT8kHz16BitStereo', 'DISPID_SDKGetStringValue',
    'DISPID_SPARecoResult', 'SVP_18', 'DISPID_SRGIsPronounceable',
    'DISPID_SpeechPhraseRule', 'eLEXTYPE_PRIVATE15',
    'DISPID_SWFEFormatTag', 'ISpRecoContext2', 'SpInProcRecoContext',
    'DISPID_SWFEAvgBytesPerSec', 'SREPhraseStart', 'SVP_2',
    'DISPID_SGRsCount', 'SREStreamStart', 'ISpeechObjectTokens',
    'SPVISEMES', 'DISPID_SPEAudioSizeBytes',
    'DISPID_SRGCmdLoadFromObject', 'DISPID_SRSNumberOfActiveRules',
    'SPSERIALIZEDRESULT', 'DISPID_SVEViseme', 'SpeechTokenValueCLSID',
    'SDTPronunciation', 'SP_VISEME_16', 'SP_VISEME_13',
    'SAFTADPCM_11kHzMono', 'SRTStandard', 'SAFT11kHz8BitStereo',
    'ISequentialStream', 'SpVoice', 'SREPropertyStringChange',
    'ISpGrammarBuilder', 'SPSFunction', 'DISPID_SAStatus', 'SVP_4',
    'SDTReplacement', 'DISPID_SRCVoicePurgeEvent',
    'DISPID_SPPNumberOfElements', 'SGRSTTRule',
    'DISPID_SpeechAudioBufferInfo', 'SPAUDIOBUFFERINFO',
    'DISPID_SLPLangId', 'DISPID_SOTRemoveStorageFileName',
    'SpObjectToken', 'SDA_Consume_Leading_Spaces',
    'DISPID_SRSCurrentStreamPosition', 'SGLexical',
    'SGPronounciation', 'SpeechPropertyNormalConfidenceThreshold',
    'SAFTCCITT_ALaw_22kHzStereo', 'SPSMF_SRGS_SAPIPROPERTIES',
    'SPEI_UNDEFINED', 'SPPHRASEREPLACEMENT', 'DISPID_SVSPhonemeId',
    'ISpVoice', 'SSFMCreateForWrite', 'DISPID_SpeechXMLRecoResult',
    'SpeechRegistryUserRoot', 'SLTApp', 'DISPID_SOTDataKey',
    'DISPID_SGRSRule', 'DISPID_SABufferNotifySize',
    'SPGRAMMARWORDTYPE', 'ISpeechPhraseProperty',
    'DISPID_SRIsUISupported', 'SWPUnknownWordPronounceable',
    'SpeechRecoProfileProperties', 'DISPID_SpeechPhraseReplacements',
    'SpeechAllElements', 'SREStreamEnd', 'DISPID_SpeechGrammarRules',
    'SP_VISEME_2', 'ISpRecoResult', 'DISPID_SDKSetStringValue',
    'DISPID_SPIGrammarId', 'SECFIgnoreKanaType',
    'SpeechRecognitionType', 'DISPID_SLAddPronunciation',
    'SGSExclusive', 'SPCT_COMMAND', 'SPSNotOverriden',
    'SpSharedRecoContext', 'DISPID_SPIElements', 'DISPID_SOTsCount',
    'DISPID_SRRDiscardResultInfo', 'ISpeechFileStream',
    'SPPS_RESERVED1', 'DISPID_SRGDictationUnload',
    'ISpeechCustomStream', 'SPEI_ADAPTATION',
    'SpeechPropertyAdaptationOn', 'DISPID_SOTCGetDataKey',
    'SPPS_Modifier', 'SP_VISEME_4', 'SVSFNLPMask', 'SECFIgnoreCase',
    'DISPID_SBSSeek', 'SPEI_MAX_TTS', 'SVSFDefault',
    'DISPID_SRCEPropertyStringChange', 'SPAO_NONE',
    'DISPID_SRGCmdLoadFromMemory', 'DISPID_SPPFirstElement',
    'DISPID_SPEDisplayText', 'DISPID_SWFEBitsPerSample',
    'SPGS_ENABLED', 'SAFTCCITT_uLaw_44kHzMono', 'eLEXTYPE_PRIVATE2',
    'DISPID_SDKOpenKey', 'eLEXTYPE_PRIVATE20', 'ISpLexicon',
    'eLEXTYPE_RESERVED4', 'DISPID_SRRAudioFormat',
    'SpeechRecoContextState', 'DISPID_SPEAudioSizeTime', 'SITooLoud',
    ...
    'SpUnCompressedLexicon', 'ISpRecoGrammar', 'SPRST_ACTIVE',
    'SRADynamic', 'SPEI_MIN_TTS', 'ISpeechPhraseProperties',
    'SAFTCCITT_ALaw_8kHzMono', 'DISPID_SRSetPropertyString',
    'SAFT48kHz16BitMono', 'SVSFPersistXML',
    'SpeechGrammarTagUnlimitedDictation', 'DISPID_SRRGetXMLErrorInfo',
    'SDA_Two_Trailing_Spaces', 'SPXRO_SML', 'SPRECOCONTEXTSTATUS',
    'SPRST_ACTIVE_ALWAYS', 'SAFTNoAssignedFormat', 'DISPID_SPRText',
    'SVP_13', 'SDTRule', 'ISpEventSink', 'DISPID_SAFType',
    'SDTAlternates', 'SpeechUserTraining', 'ISpeechGrammarRules',
    'DISPID_SPEAudioTimeOffset', 'DISPID_SVSInputSentencePosition',
    'SPINTERFERENCE_TOOLOUD', 'IInternetSecurityManager',
    'DISPID_SRRPhraseInfo', 'SPEI_SR_BOOKMARK', 'SPPHRASEPROPERTY',
    'DISPID_SVSLastBookmarkId', 'ISpeechLexiconPronunciations',
    'ISpAudio', 'SpeechCategoryAudioIn', 'SPVOICESTATUS',
    'DISPID_SpeechLexiconProns', 'SDA_One_Trailing_Space',
    'SPRECORESULTTIMES', 'SECNormalConfidence',
    ...
    'SPEI_TTS_AUDIO_LEVEL', 'SPWT_DISPLAY', 'SGSDisabled',
    'DISPID_SPACommit', 'SECFIgnoreWidth', 'DISPID_SOTCSetId',
    'SAFT16kHz16BitStereo', 'DISPID_SRCERecognition',
    'DISPID_SGRSTRule', 'DISPID_SVGetVoices', 'ISpeechGrammarRule',
    'SWPKnownWordPronounceable', 'IEnumString', 'DISPID_SLPType',
    ...
    'DISPID_SMSALineId', 'DISPID_SRCRetainedAudio', 'DISPID_SOTId',
    'SPAS_PAUSE', 'DISPID_SGRSTNextState', 'eLEXTYPE_PRIVATE18',
    ...
    'DISPID_SOTCDefault', 'SpeechPartOfSpeech',
    'SpeechCategoryRecoProfiles', 'SPEI_END_SR_STREAM',
    'ISpeechVoice', 'SPSMF_SAPI_PROPERTIES', 'SpeechMicTraining',
    'SECFEmulateResult', 'ISpeechAudioStatus',
    'DISPID_SOTCreateInstance', 'SRTReSent', 'SPSHT_EMAIL',
    'SREAllEvents', 'SAFTExtendedAudioFormat', 'SPEI_RESERVED1',
    'ISpeechRecoResult2', 'DISPID_SDKDeleteKey', 'SPPS_Noun',
    'SpeechAudioState', 'ISpeechGrammarRuleState',
    'SPINTERFERENCE_TOOSLOW', 'SAFT24kHz8BitStereo',
    'DISPID_SpeechRecognizerStatus', 'DISPID_SLPsItem',
    'SPEI_RESERVED6', 'SRARoot', 'SPWP_KNOWN_WORD_PRONOUNCEABLE',
    'SpStreamFormatConverter', 'SITooSlow', 'DISPID_SGRClear',
    'DISPID_SDKSetBinaryValue', 'DISPID_SGRSTPropertyValue',
    'SVSFIsFilename', 'SAFTGSM610_8kHzMono', 'SpStream',
    'DISPID_SpeechFileStream', 'DISPID_SRCEStartStream',
    'DISPID_SVEventInterests', 'SPSHORTCUTPAIR', 'SVP_21',
    'SPINTERFERENCE_NOSIGNAL', 'SRSActive',
    'DISPID_SOTGetDescription', 'SpeechTokenIdUserLexicon',
    'ISpeechRecoGrammar', 'SRTSMLTimeout',
    'ISpeechLexiconPronunciation', 'SAFT48kHz8BitMono',
    'DISPID_SpeechRecoResult', 'SPXRO_Alternates_SML',
    'SGLexicalNoSpecialChars', 'DISPID_SPRuleEngineConfidence',
    'IInternetSecurityMgrSite', 'DISPID_SLPs_NewEnum',
    'DISPID_SPPValue', 'SP_VISEME_0', 'STSF_LocalAppData',
    'DISPID_SVSLastStreamNumberQueued', 'DISPID_SVEAudioLevel',
    'SPRST_NUM_STATES', 'DISPID_SRGRecoContext', 'SP_VISEME_20',
    'DISPID_SGRSTs_NewEnum', 'ISpeechGrammarRuleStateTransition',
    'SPAUDIOOPTIONS', 'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE',
    ...
    'SVP_10', '_SPAUDIOSTATE', 'DISPID_SRAudioInputStream',
    'DISPID_SGRSTText', 'DISPID_SOTMatchesAttributes',
    'SpeechRecoEvents', 'SVF_None', 'SRSInactive', 'DISPID_SPAsItem',
    ...
    'DISPID_SRCEBookmark', 'eLEXTYPE_PRIVATE8',
    'SDA_No_Trailing_Space', 'DISPID_SADefaultFormat',
    'SpNullPhoneConverter', 'DISPID_SVAudioOutput', 'SASStop',
    'DISPID_SRSetPropertyNumber', 'DISPID_SRCCmdMaxAlternates',
    'DISPID_SPPId', 'SPEI_RESERVED2', 'SPEI_MAX_SR',
    'DISPID_SVIsUISupported', 'DISPID_SVSpeakCompleteEvent',
    'SSFMOpenForRead', 'DISPID_SRCEFalseRecognition', 'SP_VISEME_7',
    'SPEI_REQUEST_UI', 'DISPID_SVSRunningState', 'SPAR_Low',
    'DISPID_SPEDisplayAttributes', 'SPADAPTATIONRELEVANCE',
    'SGRSTTWord', 'DISPID_SOTCId', 'SPCATEGORYTYPE',
    'SpeechVisemeFeature', 'SAFT22kHz8BitMono', 'eLEXTYPE_PRIVATE11',
    'DISPID_SASState', 'SpeechVisemeType', 'SPSLMA', 'SpMMAudioOut',
    'SpeechInterference', 'DISPIDSPTSI', 'DISPID_SLWPronunciations',
    'DISPID_SOTGetStorageFileName', 'SVPNormal', 'SPBINARYGRAMMAR',
    ...
    'DISPID_SpeechAudio', 'SVP_15', 'DISPID_SpeechPhraseProperties',
    'SpAudioFormat', 'SPLO_STATIC', 'DISPID_SVResume',
    'DISPID_SPERetainedSizeBytes', 'DISPID_SRCESoundStart',
    'DISPID_SGRSAddRuleTransition', 'SVP_17',
    'DISPID_SPANumberOfElementsInResult', 'SINoSignal',
    'SREAudioLevel', 'ISpeechWaveFormatEx',
    'SAFTCCITT_uLaw_44kHzStereo', 'STSF_AppData', 'SSTTTextBuffer',
    'ISpeechBaseStream', 'SPEI_RECO_OTHER_CONTEXT', 'SPGRAMMARSTATE',
    'DISPID_SVEWord', 'SVP_14', 'SAFT24kHz16BitStereo', 'SDTAudio',
    'DISPID_SpeechVoice', 'DISPID_SGRSTPropertyId',
    'DISPID_SpeechVoiceEvent', 'DISPID_SVEStreamStart',
    'SpTextSelectionInformation', 'DISPID_SPRulesCount',
    'SPEI_RESERVED5', 'SAFT32kHz8BitMono', 'DISPID_SPEsItem',
    'DISPID_SFSClose', 'Speech_StreamPos_Asap', 'SPLEXICONTYPE',
    'SDTDisplayText', 'SPSUnknown', 'SAFT48kHz16BitStereo',
    'ISpeechPhraseAlternates', 'DISPID_SpeechPhraseInfo',
    'SpPhoneConverter', 'SAFTGSM610_11kHzMono', 'DISPID_SGRAddState',
    'SpeechPropertyResponseSpeed', 'SP_VISEME_8',
    'SAFT11kHz16BitMono', 'SAFT32kHz16BitStereo', 'DISPID_SPPName',
    'ISpeechLexicon', 'SAFT44kHz8BitMono', 'DISPID_SPRs_NewEnum',
    'DISPID_SGRsDynamic', 'SVSFParseAutodetect',
    'DISPID_SRCEInterference', 'SpeechGrammarTagWildcard',
    'SpeechPropertyComplexResponseSpeed', 'SPBO_AHEAD', 'SVP_9',
    'DISPID_SRCCreateResultFromMemory', 'SPSHORTCUTPAIRLIST',
    'SpeechTokenKeyUI', 'SAFTGSM610_22kHzMono', 'SpeechLexiconType',
    'ISpeechPhraseRules', 'SP_VISEME_19', 'DISPID_SRGState',
    'SAFT44kHz8BitStereo', 'SP_VISEME_12', 'SREPrivate',
    'SPVPRI_NORMAL', 'DISPID_SpeechRecoResultTimes',
    'SAFTNonStandardFormat', 'SPINTERFERENCE_TOOQUIET',
    'DISPID_SMSSetData', 'DISPID_SGRAttributes', 'eLEXTYPE_PRIVATE19',
    'ISpeechPhraseAlternate', 'ISpNotifySink', 'SPSHT_Unknown',
    'SpeechGrammarWordType', 'SP_VISEME_5', 'SP_VISEME_3',
    'SPPS_Function', 'SREFalseRecognition', 'SRTExtendableParse',
    'SSSPTRelativeToStart', 'SVEPrivate', 'ISpeechPhoneConverter',
    'SGSEnabled', 'DISPID_SWFEBlockAlign', 'ISpeechMemoryStream',
    'DISPID_SpeechCustomStream', 'SPRST_INACTIVE',
    'DISPID_SRCEEnginePrivate', 'SVSFIsNotXML', 'DISPID_SLWsItem',
    'SPDKL_LocalMachine', 'tagSTATSTG', 'SDTLexicalForm',
    'DISPID_SGRSTType', 'DISPID_SRRTOffsetFromStart',
    'STCRemoteServer', 'ISpEventSource', 'DISPID_SPCPhoneToId',
    'SPEI_PHONEME', 'SVF_Emphasis', 'SGDisplay', 'SPEI_VISEME',
    'DISPID_SGRSTsCount', 'SpInprocRecognizer', 'SPEI_RESERVED3',
    'SPDKL_CurrentUser', 'DISPID_SOTCategory', 'SBOPause',
    'DISPID_SPEsCount', 'DISPID_SGRsCommitAndSave', 'SP_VISEME_18',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_MS', 'SPPS_Unknown',
    'STCLocalServer', 'SpMMAudioIn', 'SVSFPurgeBeforeSpeak',
    'tagSPPROPERTYINFO', 'SPEI_TTS_BOOKMARK', 'SPWT_LEXICAL',
    'SpMMAudioEnum', 'ISpeechRecoResultTimes',
    'SAFTADPCM_22kHzStereo', 'ISpDataKey', 'SpeechRuleAttributes',
    'DISPID_SPEActualConfidence', 'SpeechTokenKeyFiles',
    'SPLOADOPTIONS', 'SP_VISEME_15', 'DISPID_SRGetFormat',
    'DISPID_SpeechAudioFormat', 'SVP_1', 'SPPS_Noncontent',
    'SAFTADPCM_8kHzStereo', 'SpeechVoiceSpeakFlags',
    'DISPID_SGRSAddWordTransition', 'SVP_8', 'DISPID_SRRAudio',
    'SVSFParseMask', 'SPRS_INACTIVE', 'SVP_6', 'SpCustomStream',
    'DISPID_SpeechLexiconWord', 'DISPID_SGRAddResource',
    'DISPID_SGRId', 'DISPID_SGRsFindRule', 'ISpeechVoiceStatus',
    'DISPID_SRRGetXMLResult', 'SASClosed', 'DISPID_SPIGetText',
    'SPPS_RESERVED4', 'SAFTDefault', 'eLEXTYPE_USER',
    'DISPID_SGRSAddSpecialTransition', 'DISPID_SVGetProfiles',
    'DISPID_SpeechBaseStream', 'SREInterference', 'SVEPhoneme',
    'DISPID_SAFGuid', 'SpeechCategoryRecognizers', 'SSFMCreate',
    'ISpeechPhraseElement', 'SPEI_SOUND_START', 'eLEXTYPE_MORPHOLOGY',
    'DISPID_SpeechLexiconPronunciation', 'DISPID_SVEStreamEnd',
    'STSF_FlagCreate', 'DISPID_SPIAudioSizeTime',
    'DISPID_SPIAudioStreamPosition', 'DISPID_SRCRetainedAudioFormat',
    'SPPS_LMA', 'DISPID_SpeechPhraseElement', 'ISpMMSysAudio',
    'ISpeechAudioBufferInfo', 'DISPID_SpeechGrammarRule',
    'SAFT44kHz16BitMono', 'SPPS_RESERVED2', 'SAFT32kHz8BitStereo',
    'SVSFParseSsml', 'SRSActiveAlways', 'SPEI_PROPERTY_STRING_CHANGE',
    'eLEXTYPE_VENDORLEXICON', 'DISPID_SPEs_NewEnum',
    'SPINTERFERENCE_NOISE', 'SECHighConfidence',
    'SPWP_UNKNOWN_WORD_PRONOUNCEABLE', 'SpPhraseInfoBuilder',
    'SREStateChange', 'SPFM_OPEN_READONLY', 'SpResourceManager',
    'DISPID_SPISaveToMemory', '_ISpeechVoiceEvents',
    'SAFTCCITT_ALaw_44kHzStereo', 'STCAll',
    'DISPID_SLGetGenerationChange', 'DISPID_SOTs_NewEnum',
    'SAFTADPCM_22kHzMono', 'SGDSActive', 'DISPID_SVSLastBookmark',
    'SGRSTTWildcard', 'DISPID_SRSAudioStatus', 'SVP_3',
    'DISPID_SRCVoice', 'SAFTGSM610_44kHzMono', 'DISPID_SVSVisemeId',
    'SAFT44kHz16BitStereo', 'DISPID_SGRs_NewEnum',
    'SAFT48kHz8BitStereo', 'DISPID_SRSClsidEngine',
    'DISPIDSPTSI_ActiveOffset', 'DISPID_SRCreateRecoContext',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C', 'SREAdaptation',
    'SPDATAKEYLOCATION', 'DISPID_SpeechGrammarRuleStateTransition',
    'DISPID_SpeechLexicon', 'eLEXTYPE_PRIVATE14', 'SRAExport',
    'SPBO_TIME_UNITS', 'DISPID_SPELexicalForm', 'SVP_19',
    'ISpeechAudio', 'DISPID_SRCEAdaptation',
    'DISPID_SPAStartElementInResult', 'DISPID_SRRecognizer',
    'ISpeechAudioFormat', 'DISPID_SABufferInfo',
    'SpeechEngineProperties', 'SPVPRIORITY', 'SASRun',
    'DISPID_SPPsCount', 'DISPID_SPAsCount', 'ISpPhraseAlt',
    'SPPHRASE', 'DISPID_SMSGetData', 'SPBO_NONE',
    'ISpeechLexiconWords', 'SITooQuiet', 'DISPID_SpeechMemoryStream',
    ...
    'SpeechRetainedAudioOptions', 'eLEXTYPE_PRIVATE13',
    'SPWORDPRONOUNCEABLE', 'SVSFIsXML', 'DISPID_SRRSetTextFeedback',
    'DISPID_SLWWord', 'SPDKL_DefaultLocation',
    'DISPID_SVEVoiceChange', 'DISPID_SPIReplacements',
    'DISPID_SRGCmdLoadFromProprietaryGrammar', 'SPSSuppressWord',
    'SPEI_WORD_BOUNDARY', 'SPAS_STOP', 'SAFTCCITT_ALaw_44kHzMono',
    'SAFT12kHz8BitStereo', 'SRERecognition', 'DISPID_SPIEngineId',
    ...
    'DISPID_SpeechRecoContext', 'DISPID_SGRsItem',
    'IEnumSpObjectTokens', 'ISpObjectTokenCategory',
    'SPSTREAMFORMATTYPE', 'eLEXTYPE_USER_SHORTCUT',
    'DISPID_SRRTLength', 'SVPOver', 'SPRECOGNIZERSTATUS',
    'DISPID_SPRuleId', 'SPVPRI_ALERT', 'ISpeechXMLRecoResult',
    'DISPID_SPRsCount', 'SPWORD', 'DISPID_SRGRules',
    'DISPID_SpeechObjectTokens', 'DISPID_SOTIsUISupported',
    'DISPID_SRGCmdSetRuleIdState', 'SPTEXTSELECTIONINFO',
    'SpeechDictationTopicSpelling', 'DISPID_SDKEnumKeys',
    'DISPID_SPCLangId', 'SPRULE', 'DISPIDSPRG',
    'DISPID_SRCRecognizer', 'SPEVENTENUM', 'DISPID_SOTsItem',
    'SPPS_Verb', 'SPEI_RECOGNITION', 'SP_VISEME_6',
    'SAFTCCITT_ALaw_11kHzStereo', 'DISPID_SVSpeak',
    'SAFT22kHz16BitMono', 'DISPID_SOTRemove',
    ...
    'SpeechDiscardType', 'DISPID_SRAudioInput', 'DISPID_SRGId',
    'Speech_StreamPos_RealTime',
    'DISPID_SRCERecognitionForOtherContext', 'SRTEmulated',
    'DISPID_SLWsCount', 'DISPID_SPAs_NewEnum', 'DISPID_SGRsAdd',
    'SLOStatic', 'DISPID_SGRName', 'DISPID_SVGetAudioInputs',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'SpeechEngineConfidence', 'SPBO_PAUSE', 'eLEXTYPE_PRIVATE5',
    'DISPID_SASCurrentDevicePosition',
    'SPINTERFERENCE_LATENCY_TRUNCATE_END', 'SpeechTokenKeyAttributes'
]

_check_version('1.1.14', 1666572683.625627)
